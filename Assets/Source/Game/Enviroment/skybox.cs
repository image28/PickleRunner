...
public class skybox : MonoBehaviour {
	...
	IEnumerator crTransition(Color color, float time) {
		...
		float i = 0.0f;
		MeshRenderer gmr = (MeshRenderer)gSkybox.GetComponent(stringManager.Instance.skybox0);
	...
	IEnumerator crTransition(SkyboxType type, float time) {
		...
		tSkybox = createSkybox(stringManager.Instance.skybox1, textures);
		tSkybox.parent = gSkybox.parent;
		MeshRenderer gmr = (MeshRenderer)gSkybox.GetComponent(stringManager.Instance.skybox2);
		MeshRenderer tmr = (MeshRenderer)tSkybox.GetComponent(stringManager.Instance.skybox3);
